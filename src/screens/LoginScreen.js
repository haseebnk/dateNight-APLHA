                ...
                <TouchableOpacity>
                    <View style={styles.tog}>
                        <TouchableOpacity
                            ...
                            <Text style={{ color: !toggleActive ? 'white' : 'black', fontSize: 15,  position: 'absolute', bottom: Platform.OS ==='ios' ? moderateScale(0.9, 0.1) :moderateScale(1.9,0), right: Platform.OS ==='ios' ? moderateScale(5.5, 0.1): moderateScale(6,0)}}>N</Text>
                        </TouchableOpacity>
